  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="container mx-auto flex min-h-screen items-center justify-center px-6">
        <form onSubmit={LoginIn} className="w-full max-w-md">
          <Link to="/">
            <img
          ...
          <h1 className="mt-3 text-2xl font-semibold capitalize text-gray-800 sm:text-3xl dark:text-white">
            sign In
          </h1>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 flex transform items-center justify-center rounded-lg border px-6 py-3 text-gray-600 transition-colors duration-300 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-600">
              <svg className="mx-2 h-6 w-6" viewBox="0 0 40 40">
                <path
