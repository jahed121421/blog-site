        ...
        <div className="container mx-auto px-6 py-12">
          <div className="lg:-mx-6 lg:flex lg:items-center">
            ...
            <div className="mt-8 lg:mx-6 lg:w-1/2">
              <div className="mx-auto w-full overflow-hidden rounded-lg bg-white px-8 py-10 shadow-2xl shadow-gray-300/50 lg:max-w-xl dark:bg-gray-900 dark:shadow-black/50">
                ...
                <form className="mt-6">
                  ...
                  <div className="mt-6 w-full">
                    ...
                    <textarea
                      className="mt-2 block h-32 w-full rounded-md border border-gray-200 bg-white px-5 py-3 text-gray-700 placeholder-gray-400 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-40 md:h-48 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-600 dark:focus:border-blue-400"
                      placeholder="Message"
                    ></textarea>
                  </div>
